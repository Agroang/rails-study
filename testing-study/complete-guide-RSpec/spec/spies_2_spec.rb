...
RSpec.describe Garage do
  ...
  before do
    ...
    # we are interceding a making the #new method returns our instance double
    # the allow here also grants spy-like functionalities to the specs later
  end

  it 'adds a car to its storage' do
    subject.add_to_collection('Honda Civic')
    expect(Car).to have_received(:new).with('Honda Civic') # spy-like
